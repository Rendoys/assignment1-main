...
int yearsOld(tm* inputTgl, tm* currentTgl)
{
    ...
    // Cek: Jika bulan sekarang belum sampai bulan lahir, 
    // atau bulannya sama tapi tanggalnya belum sampai, berarti belum genap setahun.
...
int monthsOld(tm* inputTgl, tm* currentTgl)
{
    ...
    // Jika tanggal hari ini belum sampai ke tanggal lahir, kurangi 1 bulan
...
string dayOfDate(tm* inputTgl)
{
    // mktime akan mengisi variabel tm_wday secara otomatis
    mktime(inputTgl);
    int indexHari = inputTgl->tm_wday; 
    
    // Array nama hari (0 = Minggu, 1 = Senin, dst)
    string namaHari[] = {"Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"};
    
    return namaHari[indexHari];
}
//*********************************************************************************************************************
//*********************************************************************************************************************
